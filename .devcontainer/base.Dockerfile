...
ENV SHELL=/bin/bash \
    ...
    PYENV_BIN_DIR="/home/${USERNAME}/.pyenv" \
...
ENV PATH="${ORIGINAL_PATH}:${NVM_DIR}/current/bin:${NPM_GLOBAL}/bin:${DOTNET_ROOT}:${DOTNET_ROOT}/tools:${SDKMAN_DIR}/bin:${SDKMAN_DIR}/candidates/gradle/current/bin:${SDKMAN_DIR}/java/current/bin:/opt/maven/lts:${CARGO_HOME}/bin:${GOROOT}/bin:${GOPATH}/bin:${PYENV_BIN_DIR}:${PIPX_BIN_DIR}:/opt/conda/condabin:${ORYX_PATHS}"
